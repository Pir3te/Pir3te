...
var = "البوت"
elseif database:sismember(bot_id.."Pir3te:Sudo:User", user_id) then
var = database:get(bot_id.."Pir3te:Sudo:Rd"..chat_id) or "المطور"  
elseif database:sismember(bot_id.."Pir3te:Basic:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."Pir3te:BasicConstructor:Rd"..chat_id) or "المنشئ اساسي"
elseif database:sismember(bot_id.."Pir3te:Constructor"..chat_id, user_id) then
var = database:get(bot_id.."Pir3te:Constructor:Rd"..chat_id) or "المنشئ"  
elseif database:sismember(bot_id.."Pir3te:Manager"..chat_id, user_id) then
var = database:get(bot_id.."Pir3te:Manager:Rd"..chat_id) or "المدير"  
elseif database:sismember(bot_id.."Pir3te:Mod:User"..chat_id, user_id) then
var = database:get(bot_id.."Pir3te:Mod:Rd"..chat_id) or "الادمن"  
elseif database:sismember(bot_id.."Pir3te:Special:User"..chat_id, user_id) then  
var = database:get(bot_id.."Pir3te:Special:Rd"..chat_id) or "المميز"  
else  
var = database:get(bot_id.."Pir3te:Memp:Rd"..chat_id) or "العضو"
end  
return var
end 
...
function Pir3te_Started_Bot(msg,data) -- بداية العمل
if msg then
...
if text == ("مسح قائمه العام") and DevPir3te(msg) then
database:del(bot_id.."Pir3te:GBan:User")
send(msg.chat_id_, msg.id_, "\n📮 ┇ تم مسح قائمه العام")
return false
end
if text == ("مسح المطورين") and DevPir3te(msg) then
...
if text == ("قائمه العام") and DevPir3te(msg) then
...
if text == ("المطورين") and DevPir3te(msg) then
...
if text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevPir3te(msg) then
...
if text and text:match("^حظر عام @(.*)$")  and DevPir3te(msg) then
...
if text and text:match("^حظر عام (%d+)$") and DevPir3te(msg) then
...
if text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and DevPir3te(msg) then
function Function_Pir3te(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevPir3te(msg) then
...
if text and text:match("^الغاء العام (%d+)$") and DevPir3te(msg) then
...
if text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevPir3te(msg) then
function Function_Pir3te(extra, result, success)
...
if text and text:match("^اضف مطور @(.*)$") and DevPir3te(msg) then
...
if text and text:match("^اضف مطور (%d+)$") and DevPir3te(msg) then
...
if text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and DevPir3te(msg) then
function Function_Pir3te(extra, result, success)
...
if text and text:match("^حذف مطور @(.*)$") and DevPir3te(msg) then
...
if text and text:match("^حذف مطور (%d+)$") and DevPir3te(msg) then
...
if Pir3tert == "مميز" and Addictive(msg) then
...
database:sadd(bot_id.."Pir3te:Special:User"..msg.chat_id_,result.sender_user_id_)  
elseif Pir3tert == "ادمن" and Owner(msg) then 
send(msg.chat_id_, msg.id_,"\n👤 ┇ العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬 ┇ تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."Pir3te:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)
database:sadd(bot_id.."Pir3te:Mod:User"..msg.chat_id_,result.sender_user_id_)  
elseif Pir3tert == "مدير" and Constructor(msg) then
send(msg.chat_id_, msg.id_,"\n👤 ┇ العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬 ┇ تم رفعه "..RTPA.." هنا\n")   
database:set(bot_id.."Pir3te:Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."Pir3te:Manager"..msg.chat_id_,result.sender_user_id_)  
elseif Pir3tert == "عضو" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"\n👤 ┇ العضو » ["..data.first_name_.."](t.me/"..(data.username_ or "BOBBW")..")".."\n📬 ┇ تم رفعه "..RTPA.." هنا\n")   
end
end,nil)   
end   
...
------------------------------------------------------------------------
if text == ("مسح ردود المطور") and DevPir3te(msg) then 
...
if text == ("ردود المطور") and DevPir3te(msg) then 
local list = database:smembers(bot_id.."Pir3te:List:Rd:Sudo")
text = "\n⛔ ┇ قائمة ردود المطور \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
...
if text == "تفعيل الاذاعه" and DevPir3te(msg) then  
database:del(bot_id.."Pir3te:Status:Bc") 
send(msg.chat_id_, msg.id_,"\n📫 ┇ تم تفعيل الاذاعه " ) 
return false
end 
if text == "تعطيل الاذاعه" and DevPir3te(msg) then  
...
if text == 'ايدي' and tonumber(msg.reply_to_message_id_) == 0 and not database:get(bot_id..'Pir3te:Lock:ID:Bot'..msg.chat_id_) then
if not database:sismember(bot_id..'Pir3te:Spam:Group'..msg.sender_user_id_,text) then
database:sadd(bot_id.."Pir3te:Spam:Group"..msg.sender_user_id_,text) 
...
if text and text:match("^ايدي @(.*)$") and not database:get(bot_id..'Pir3te:Lock:ID:Bot'..msg.chat_id_) then
...
if text == "تنظيف المشتركين" and DevPir3te(msg) then
...
if text == "تنظيف الكروبات" and DevPir3te(msg) then
...
if text == ("تحديث السورس") and DevPir3te(msg) then  
...
if text == 'جلب نسخه احتياطيه' and DevPir3te(msg) then
local list = database:smembers(bot_id..'Pir3te:Chek:Groups')  
...
if text == 'الملفات' and DevPir3te(msg) then
t = '☑ ┇ جميع الملفات : \n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n'
i = 0
for v in io.popen('ls Pir3te_Files'):lines() do
if v:match(".lua$") then
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and DevPir3te(msg) then
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and DevPir3te(msg) then
...
if text == "مسح جميع الملفات" and DevPir3te(msg) then
os.execute("rm -fr Pir3te_Files/*")
send(msg.chat_id_,msg.id_,"☑ ┇ تم حذف جميع الملفات")
return false
end
if text == 'نقل الاحصائيات' and DevPir3te(msg) then
...
if text == 'حذف كليشه المطور' and DevPir3te(msg) then
database:del(bot_id..'Pir3te:Text_Dev')
send(msg.chat_id_, msg.id_,'☑ ┇  تم حذف كليشه المطور')
end
if text == 'وضع كليشه المطور' and DevPir3te(msg) then
...
if text == 'رفع النسخه الاحتياطيه' and DevPir3te(msg) then   
...
if text == "تحديث" and DevPir3te(msg) then
dofile("Pir3te.lua")  
send(msg.chat_id_, msg.id_, "☑ ┇ تم التحديث")
end
...
if text == 'الالعاب' or text == 'العاب' or text == 'قاىمه الالعاب' then
Text = [[
🛡| اهلا بك في قاىمه الالعاب   
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📬| قائمه الالعاب لديك ↓
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
...
send(msg.chat_id_, msg.id_,'👥 ┇ عدد اعضاء المجموعه اقل من *~ {'..(database:get(bot_id..'Pir3te:Num:Add:Bot') or 0)..'* عضو')
return false
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
...
if text == 'تفعيل' and not DevBot(msg) and not database:get(bot_id..'Pir3te:Free:Add:Bots') then 
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'🚸 ┇ البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
